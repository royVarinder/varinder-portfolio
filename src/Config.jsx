...
export const SUMMARY = "Experienced Frontend / Full Stack Developer with 5+ years of hands-on experience in building scalable web applications using the MERN stack (React.js, NextJS, MongoDB, Express.js, Node.js). Strong background in frontend and backend development, REST APIs, database design, and deployment. Proven ability to lead small teams, deliver client projects, and work with international clients.";
...
export const skillCategories = [
    ...
    },
    {
        category: 'Practices',
        items: [
            { name: 'Deployment & Linux Server Administration', Icon: FaLinux },
            { name: 'Git-based Workflows', Icon: FaGitAlt },
            { name: 'Code Review' },
            { name: 'Agile Delivery' },
        ],
    },
